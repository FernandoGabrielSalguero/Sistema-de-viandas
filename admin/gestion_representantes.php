    ...
    <form method="post" action="gestion_representantes.php">
        ...
        <select id="representante_id" name="representante_id" required>
            ...
            <?php foreach ($representantes as $representante) : ?>
                <option value="<?php echo $representante['Id']; ?>"><?php echo htmlspecialchars($representante['Nombre']); ?></option>
            <?php endforeach; ?>
        </select>
        ...
        <select id="colegio_id" name="colegio_id" required>
            ...
            <?php foreach ($colegios as $colegio) : ?>
                <option value="<?php echo $colegio['Id']; ?>"><?php echo htmlspecialchars($colegio['Nombre']); ?></option>
            <?php endforeach; ?>
        </select>
