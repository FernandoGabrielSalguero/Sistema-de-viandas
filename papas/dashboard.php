...
$stmt = $pdo->prepare("
    SELECT h.Id, h.Nombre, h.Preferencias_Alimenticias, h.Colegio_Id, h.Curso_Id
    FROM Hijos h
...
$query_pedidos = "
    SELECT pc.Id, h.Nombre as Hijo, m.Nombre as Menú, 
           DATE_FORMAT(pc.Fecha_entrega, '%d/%b/%y') as Fecha_entrega, 
        ...
        <table class="mat-elevation-z8">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($hijo['Colegio_Id']); ?></td>
                    <td><?php echo htmlspecialchars($hijo['Curso_Id']); ?></td>
                    <td><?php echo htmlspecialchars($hijo['Preferencias_Alimenticias']); ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
