...
function enviarCorreo($to, $subject, $message) {
    $from = 'contacto@ilmanagastronomia.com'; // Cambia esto al correo que desees como remitente
    $headers = "From: $from\r\n" .
               "Reply-To: $from\r\n" .
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if (!enviarCorreo($correoCliente, $asunto, $mensaje)) {
            $error = "El pedido fue guardado, pero no se pudo enviar el correo.";
        }
